...
import { QuestionsC } from "@/lib/quiz-questions";
...
const questions: Question[] = QuestionsC;

const QuizComponentC: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center mt-36">
      <div className="w-full max-w-md rounded-lg shadow-md p-8">
        <h1 className="text-3xl font-bold mb-6">Quiz C</h1>
          ...
          <div>
            ...
            {score === questions.length ? (
              <>
                ...
                <GenerateCodeSendEmail quiz={"quiz-c"} />
              </>
            ) : (
